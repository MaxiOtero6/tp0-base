...
Para este ejercicio se creo el script validar-echo-server.sh el cual corre un container de una imagen de alpine en la misma red que el servidor, ejecutando netcat y enviando un mensaje al servidor con el fin de realizar un health check. Si el mensaje que se envia es el mismo que el recibido, el servidor se encuentra healthy.
