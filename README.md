...
Por dentro, este script invoca al script de python generator.py pasandole ambos argumentos. Este script generara el archivo con la cantidad de containers de clientes indicado.

De aqui en mas, toda modificacion que quiera hacerse a la ejecucion de docker-compose se debe hacer en las constantes de generator.py
