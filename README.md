...
Para este ejercicio los clientes al finalizar de leer todas las apuestas en el archivo .csv, notifican al servidor que estan listos para el sorteo e instantaneamente despues de notificarle comienzan a consultar el resultado del sorteo.

Si se consulta los resultados del sorteo previo al mismo, el servidor respondera que la accion fallo y el cliente volvera a intentar luego de ${loopPeriod}.

El servidor preserva los resultados del sorteo segun el numero de agencia, una vez que la agencia consulta por sus respectivos ganadores, el servidor deja de tener estos resultados.
