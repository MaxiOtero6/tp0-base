...
Para este ejercicio se agregaron volumenes tanto al servicio cliente como para el servidor en los cuales se utiliza un bind mount de la configuracion del respectivo servicio. De esta manera, los cambios en las configuraciones desde el host se ven reflejadas en el container.
